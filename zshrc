...
__conda_setup="$('/Users/kevinkrausse/miniforge3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/kevinkrausse/miniforge3/etc/profile.d/conda.sh" ]; then
        . "/Users/kevinkrausse/miniforge3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/kevinkrausse/miniforge3/bin:$PATH"
    fi
fi
unset __conda_setup

if [ -f "/Users/kevinkrausse/miniforge3/etc/profile.d/mamba.sh" ]; then
    . "/Users/kevinkrausse/miniforge3/etc/profile.d/mamba.sh"
fi
# <<< conda initialize <<<

mamba activate base2
