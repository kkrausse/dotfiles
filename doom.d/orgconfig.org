...
#+RESULTS:
: #s(llm-ollama "http" "10.0.1.3" 11434 "zephyr" "zephyr")
...
(setq company-minimum-prefix-length 1
      ...
      ;; display-buffer-reuse-window was disabled. But I think they updated the default
      display-buffer-base-action '(nil . nil))
...
;; TODO this is ignored bc of doom lsp module FIXME
