...
;;   :defer-incrementally org-ref)

(after! citar
  (setq citar-bibliography '("~/Desktop/bibliography/refs.bib")
...
(after! (org-roam citar)
  ...
  (setq citar-notes-paths (list (concat org-roam-directory "/citar/"))
