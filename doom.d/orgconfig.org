...
- subnode extention
  ...
  - implementation
    - property =:SUBNODE_OF: <org_id>= will mark subnodes and find those to search.
...
(defun kev/roam-subnode-create ()
  (interactive)
  (let ((parent (org-roam-node-read nil (kev/complement #'kev/roam-subnode-get-parent) nil 'require-match "parent node: ")))
...
(after! org-roam
  ...
  (map! (:map org-mode-map
              (:prefix ("C-c n" . "Org Roam")
                       ...
                       "c" #'org-id-get-create
                       "i" (cons "insert node link" #'kev/roam-subnode-find-non-subnodes)
...
** python
#+begin_src elisp
;; NOTE you have to call this manually
(add-hook! 'elpy-mode-hook
  (map! :map elpy-mode-map
        ...
        (:prefix ("e" . "Eval")
                 ...
                 "d" #'elpy-shell-send-top-statement))
