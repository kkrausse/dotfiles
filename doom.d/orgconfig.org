...
(-> 'display-buffer-alist
    (add-to-list '("\\*org-roam.*\\*" (display-buffer-reuse-window display-buffer-same-window)))
    (add-to-list '("\\*lsp-help\\*" (display-buffer-reuse-window display-buffer-same-window))))
