...
(defun kev/roam-subnode-create ()
  ...
  (let ((node (org-roam-node-at-point 'assert)))
    (save-excursion
      ...
      (org-roam-add-property "1" "HAS_SUBNODES"))
    (org-id-get-create 'force)
    (org-roam-add-property (org-roam-node-id node) "SUBNODE_OF")
    (org-roam-add-property (org-roam-node-title node) "SUBNODE_OF_TITLE")))

(defun kev/roam-node-find ()
  (interactive)
...
(after! org-roam
  ...
  (setq org-roam-v2-ack t
        org-roam-preview-function #'kevin-org-roam-preview)
